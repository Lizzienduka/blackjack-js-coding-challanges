...
function rpsGame(yourChoice = event.srcElement.id) {
...
function decideWinner(yourChoice, computerChoice) {
  ...
  var computerScore = rpsDatabase[computerChoice][yourChoice = event.srcElement.id]
...
function rpsFrontEnd(humanImageChoice, botImageChoice, finalMessage) {
  ...
  humanDiv.innerHTML = "<img src='" + imagesDatabase[humanImageChoice] + "' width= 160px style='box-shadow: 0px 10px 30px rgba(37, 50, 233, 1);'>"

  messageDiv.innerHTML = "<h1 style='color:" + finalMessage['color'] + "; font-size: 50px; padding: 30px;'>" + finalMessage['message'] + "<h1>"

  botDiv.innerHTML = "<img src='" + imagesDatabase[botImageChoice] + "' width= 150 style='box-shadow: 0px 10px 30px rgba(243, 38, 24, 1);'>"
...
function randomColors() {
  let choices = ['btn-primary', 'btn-danger', 'button-success', 'btn-warning']
...
function computeWinner() {
  ...
  if (YOU['score'] <= 21) {
    ...
    //condition: when user busts and the dealer doesnt
